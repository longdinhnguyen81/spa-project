								...
								<div class="card border-1" style="border-width:10px; border-color:rgba(254,150,0,0.63);" >
									<span class="card-img-top thumb-info thumb-info-hide-wrapper-bg">
										<span class="thumb-info-wrapper">
											<a href="{{ route('spa.service.service', str_slug($getservice->name)) }}"><img style="width: 250px;height: 200px" src="/upload/{{ $getservice->img }}" class="img-fluid" alt="{{ $getservice->title }}"></a>
											<span class="thumb-info-title">
												<span class="thumb-info-inner">{{ $getservice->catpackage->name }}</span>
												<span class="thumb-info-type" style="background-color: {{ $color }}" >{{ $getservice->name }}</span>
											</span>
										</span>
									</span>
								</div>
					...
					<div class="container">
						<div class="row align-items-center justify-content-center justify-content-lg-between pb-5 pb-lg-0">
							<div class="col-lg-5 order-2 order-lg-1 pt-4 pt-lg-0 pb-5 pb-lg-0 mt-5 mt-lg-0 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="200">
								<h2 class="font-weight-bold text-color-light text-7 mb-2 text-center">VỀ CHÚNG TÔI</h2>
								<p class="lead font-weight-light text-color-light text-4">Chúng tôi tự tin là đối tác của các bạn trong các lĩnh vực làm đẹp.</p>
								<p class="font-weight-light text-color-light text-2 mb-4 opacity-7">Đã là phụ nữ thì ai cũng có quyền đẹp và được làm đẹp. Phụ nữ sinh ra vốn đã mang trong mình vẻ đẹp và dấu ấn riêng mà không ai khác có thể có được. Hiểu được ý nghĩa thiêng liêng của việc làm đẹp đối với chị em phụ nữ, Dana mang trong mình sứ mệnh “khơi dậy vẻ đẹp vốn có của người phụ nữ”.</p>
								<a href="#" class="btn btn-dark-scale-2 btn-px-5 btn-py-2 text-2">LEARN MORE</a>
							</div>
							<div class="col-9 offset-lg-1 col-lg-5 order-1 order-lg-2 scale-2">
								<img class="img-fluid box-shadow-3 my-2 border-radius" src="/templates/spa/img/hinh-dana-team.jpg" style="width: 83%" alt="Đội ngũ Dana Spa">
							</div>
						</div>
					</div>
				</section>
					...
					<div class="row py-5 my-5">
						<div class="col-md-6 order-2 order-md-1 text-center text-md-left appear-animation mt-2 pt-1" data-appear-animation="fadeInRightShorter">
							<div class="owl-carousel owl-theme nav-style-1 mb-0" data-plugin-options="{'responsive': {'576': {'items': 1}, '768': {'items': 1}, '992': {'items': 2}, '1200': {'items': 2}}, 'margin': 25, 'loop': true, 'nav': false, 'dots': false, 'autoplay': true, 'autoplayTimeout': 3000}">
								<div>
									<img class="img-fluid rounded-0 mb-4" src="/templates/spa/img/bac-si/18.jpg" style="height: 400px" alt="Đội ngũ bác sĩ Dana Spa" />
									<h3 class="font-weight-bold text-color-dark text-4 mb-0">John Doe</h3>
									<p class="text-3 mb-0">Bác sĩ da liễu</p>
								</div>
								<div>
									<img class="img-fluid rounded-0 mb-4" src="/templates/spa/img/bac-si/22.jpg" style="height: 400px" alt="Đội ngũ bác sĩ Dana Spa" />
									<h3 class="font-weight-bold text-color-dark text-4 mb-0">Jessica Doe</h3>
									<p class="text-3 mb-0">Bác sĩ da liễu</p>
								</div>
								<div>
									<img class="img-fluid rounded-0 mb-4" src="/templates/spa/img/bac-si/4.jpg" style="height: 400px" alt="Đội ngũ bác sĩ Dana Spa" />
									<h3 class="font-weight-bold text-color-dark text-4 mb-0">Chris Doe</h3>
									<p class="text-3 mb-0">Bác sĩ giải phẫu</p>
								</div>
								<div>
									<img class="img-fluid rounded-0 mb-4" src="/templates/spa/img/bac-si/21.jpg" style="height: 400px" alt="Đội ngũ bác sĩ Dana Spa" />
						...
						<div class="col-md-6 order-1 order-md-2 text-center text-md-left mb-5 mb-md-0 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="200">
							...
							<p class="lead">Đội ngũ bác sĩ đến từ nước ngoài có nhiều năm kinh nghiệm trong nghề</p>
							<p class="mb-4">Đội ngũ tư vấn viên nhiệt tình với sự tư vấn ở nhiều phương tiện khác nhau: Điện thoại, messenger...</p>
						...
						<div class="row">
							...
							<div class="col appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200">
								<div class="owl-carousel owl-theme show-nav-hover" data-plugin-options="{'items': 1, 'margin': 10, 'loop': true, 'nav': false, 'dots': false, 'autoplay': true, 'autoplayTimeout': 4000}">
									...
									<div class="row">
										<div class="col-lg-4 order-lg-2">
											<img src="/templates/spa/img/tham-my/avatar/khach-hang-3.png" class="img-fluid" alt="">
										</div>
										<div class="col-lg-7 order-lg-1">
											<div class="testimonial testimonial-style-2 testimonial-with-quotes mb-0">
												<blockquote>
