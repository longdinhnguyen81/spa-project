									...
									<div class="row mb-3">
										<div class="col-lg-5">
											<div class="post-image">
												<a href="{{ route('spa.news.detail', ['slug' => $slug, 'id' => $id ]) }}">
										...
										<div class="col-lg-7">
											<div class="post-content">
												<h2 class="font-weight-semibold text-5 line-height-4 mb-2"><a href="{{ route('spa.news.detail', ['slug' => $slug, 'id' => $id ]) }}">{{ $title }}</a></h2>
									...
									<div class="row">
										<div class="col">
											<div class="post-meta">
												...
												<span><i class="far fa-folder"></i> <a href="">{{ $name }}</a></span>
												<span class="d-block d-sm-inline-block float-sm-right mt-3 mt-sm-0"><a href="{{ route('spa.news.detail', ['slug' => $slug, 'id' => $id ]) }}" class="btn btn-xs btn-light text-1 text-uppercase">Chi tiết</a></span>
											</div>
										</div>
									</div>
								</article>
...
<meta property="og:url" itemprop="url" content="{{ route('spa.news.news', str_slug($name)) }}">
